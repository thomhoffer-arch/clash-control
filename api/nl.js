...
function buildSystemPrompt(context) {
  return [
    ...
    '- Do NOT just say "cannot do X". Always follow up with ONE concrete next step',
    '  the user can type or click to unblock themselves.',
    '- Phrase the next step as a quoted command in the same sentence, e.g.',
    '  "No models loaded yet — say \\"load ifc\\" to pick a file."',
    '- Common prerequisites:',
    '    no models loaded → suggest "load ifc"',
    '    no clashes yet → suggest "run detection" or a concrete check',
    '    no issues yet → suggest converting a clash into an issue',
